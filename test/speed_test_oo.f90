...
!  ![Plot of results](https://raw.githubusercontent.com/jacobwilliams/bspline-fortran/master/src/tests/results/speed_test_oo.png)
    ...
    s2 = bspline_2d(x,y,fcn_2d,kx,ky)                    ; if (.not. s2%status_ok()) error stop 'error initializing s2'
    s3 = bspline_3d(x,y,z,fcn_3d,kx,ky,kz)               ; if (.not. s3%status_ok()) error stop 'error initializing s3'
    s4 = bspline_4d(x,y,z,q,fcn_4d,kx,ky,kz,kq)          ; if (.not. s4%status_ok()) error stop 'error initializing s4'
    s5 = bspline_5d(x,y,z,q,r,fcn_5d,kx,ky,kz,kq,kr)     ; if (.not. s5%status_ok()) error stop 'error initializing s5'
    s6 = bspline_6d(x,y,z,q,r,s,fcn_6d,kx,ky,kz,kq,kr,ks); if (.not. s6%status_ok()) error stop 'error initializing s6'
